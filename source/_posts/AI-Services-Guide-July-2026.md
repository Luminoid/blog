...
- **Gemini 3.5 Flash** shipped at [I/O on May 19](https://blog.google/innovation-and-ai/models-and-research/gemini-models/gemini-3-5/) at $1.50/$9, with Google claiming 4x faster output than other frontier models. **Gemini 3.5 Pro** was promised for June and has slipped twice; as of this writing it sits in an allowlist-only Vertex preview with no GA date.
