...
There are three ways to deploy static site on Github Pages. I tend to use the third scheme myself. The related Github documentation can be found [here](https://help.github.com/articles/configuring-a-publishing-source-for-github-pages/).
...
### Disadvantage
Only website content is under the version control. The code that generates the web content is maintained locally.
